 ...
 */
final class Version20211119112104 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE announces ADD description LONGTEXT DEFAULT NULL, ADD max_animals INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE announces DROP description, DROP max_animals');
    }
}
